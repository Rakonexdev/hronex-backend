...
class CreatePipAppraisalReports extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pip_appraisal_reports', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('hod_rating_avg_compt')->nullable();
            $table->string('hod_rating_avg_chart')->nullable();
            $table->string('principal_rating')->nullable();
            $table->string('principal_rating_avg_compt')->nullable();
            $table->string('principal_rating_avg_chart')->nullable();
    ...
    {
        Schema::dropIfExists('pip_appraisal_reports');
    }
}
