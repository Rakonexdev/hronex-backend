...
class AcademicAttendanceController extends HrmController
{
    ...
    public function index()
    {
        ...
        $startDate = Carbon::now()->subDays($back)->startOfDay();

        // Get the date 2 days in the future
        ...
        return view('attendance.academic_attendance',compact('acadmic_employees', 'startDate', 'endDate', 'interval'));
    }
    ...
    public function getdata(Request $request,$startDate)
    {
        ...
        return view('attendance.academic_attendance_ajax_data',compact('acadmic_employees','startDate','endDate', 'interval'));
    }
