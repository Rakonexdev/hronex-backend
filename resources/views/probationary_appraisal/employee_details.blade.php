...
@endphp
  ...
  <form action="{{route('probationary-appraisals.store')}}" method="POST" onsubmit="return validateForm()">
    @csrf
    <div class="row">
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <!-- <td scope="row" colspan="2">
                              <select id="inputEmail5" class="form-select" style="color: #8D8D8D;" name="future_recommended[]" >
                                @if($role->hasRole(HR_ROLE))
                                  <option value="Hr" selected>HR</option>
                                @elseif($role->hasRole('Principal'))
                                  <option value="Principal" selected>Principal</option>
                                @elseif('Vp')
                                  <option value="Vp" selected>Vice-Principal</option>
                                @endif
                              </select>
                            </td> -->
                          </tr>
