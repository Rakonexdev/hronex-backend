        ...
        <div class="col-lg-8">
          ...
          @if(isset($curacc[$userRole]))
            ...
            @if(in_array('AE', $curacc[$userRole]))
              ...
              @endif
             <!--Visa Expiry -->
             @if(isset($curacc[$userRole]) && in_array('VE', $curacc[$userRole]))
              <!-- Visa Expiry Card -->
              <div class="col-xxl-4 col-md-6">
                <div class="card info-card sales-card">
                  ...
                  <div class="filter">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                      ...
                      <li><a class="dropdown-item" href="{{url('employees')}}?type=VE">View more</a></li>

                    </ul>
                  </div>

                  <div class="card-body">
                    <h5 class="card-title">Visa Expiry</h5>
