  ...
  <form action="{{route('scf.update',$scf->id)}}" method="POST">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
          ...
          <input type="date" class="form-control" id="date" style="color: #8D8D8D;" name="date" value="{{$scf->scf_date}}">
        </div>        
    </div>
                          ...
                          @endphp
                            @foreach($scf_datas as $index => $concern)
                                ...
                                <tr>
                                    ...
                                    <th colspan="2">
                                        <textarea class="form-control" name="concerns[]" placeholder="Enter Your FeedBack">{{$ans}}</textarea>
                                    </th>
                                </tr>
                            @endforeach
                            <tr>
                                ...
                                <th>
                                    <input type="date" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="concern_date" value="{{$scf->date_of_concern}}">
                                </div>
                                </th>
                            </tr>
                        </tbody>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <th colspan="2">
                                <textarea class="form-control" placeholder="Enter your Description" name="description">{{$scf->breif_description}}</textarea>
                            </th>
                          </tr>
                          <tr>
                            <th colspan="2">Suggestions made:</th>
                            <th colspan="2">
                                <textarea class="form-control" placeholder="Enter your Suggestion" name="suggestion">{{$scf->suggestions_made}}</textarea>
                            </th>
                          </tr>  
                          <tr>
                            <th colspan="2">Update/follow-up:</th>
                            <th colspan="2">
                                <textarea class="form-control" placeholder="Enter your Suggestion" name="followup">{{$scf->follow_up}}</textarea>
                            </th>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td scope="row" colspan="2">
                              <div class="col-12" style="padding: 0px;">
                                <textarea class="form-control" id="inputAddress2" style="height: 100px; color: #8D8D8D;" name="comments" value="" placeholder="Enter Comment">{{$scf->comment}}</textarea>
                              </div>
                            </td>
                          </tr>
                          <tr>
                            ...
                            <td scope="row" colspan="2">
                              <div class="col-12" style="padding: 0px;">
                                <textarea class="form-control" id="inputAddress2" style="height: 100px; color: #8D8D8D;" name="raising_concern" value="" placeholder="Enter Concern">{{$scf->raising_concern}}</textarea>
                              </div>
                            </td>
                          </tr>
                          <tr>
