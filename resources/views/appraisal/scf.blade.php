...
<div class="pagetitle">
  <div class="row align-items-center">
    ...
    <div class="col">
      <div class="pagetitle">
        <h1>Staff Concern Form</h1>
        <nav>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{url('dashboard')}}">Home</a></li>
            <li class="breadcrumb-item active">SCF</li>
          </ol>
        </nav>
      </div>
    </div>
        ...
        @foreach($employees as $employee)    
          <tbody>
            <tr role="row" class="odd">
              ...
              <td>@if($employee->scf) {{date('d-m-Y', strtotime($employee->scf->scf_date))}} @endif</td>
              <td>            
              ...
              <td>               
                ...
                ?>            
                  @if($employee->scf)
                    <div class="action-btn bg-yellow-500 ms-2" style="margin-left: 0px !important;">
                      <a href="#" data-target=".scf_modal" data-toggle="modal" onclick="editEmployeeDetails('{{$employee->scf->id}}')"  data-id="{{$employee->id}}" >
                  ...
                  @else
                    <div class="action-btn bg-green-500 ms-2" style="margin-left: 0px !important;">
                      <a href="#" data-target=".scf_modal" data-toggle="modal" onclick="getEmployeeDetails('{{$employee->id}}')"  data-id="{{$employee->id}}" >
                  ...
                  @if($employee->scf)
                    <div class="action-btn bg-blue-500 ms-2" style="margin-left: 0px !important;">
                        <a href="#" data-target=".scf_modal" data-toggle="modal" onclick="viewEmployeeDetails('{{$employee->scf->id}}')"  data-id="{{$employee->id}}">
                            <i class="bi bi-eye"
                ...
                @if($user->hasRole(SUPER_ADMIN_ROLE))
                  ...
                  <div class="action-btn bg-red-500 ms-2">
                    <a href="{{route('scf.delete',$employee->scf->id)}}" >
...
<div id="scf_modal" class="modal scf_modal  custom-modal fade" role="dialog" style="display: none;" aria-hidden="true">
