@php
    ...
    $role = $user->role;
@endphp
<form action="{{url('appraisal/update')}}/{{$appraisal_datas->id}}" method="POST">
    @csrf
    @method('PUT')
    <div class="row">
      ...
      <div class="col-sm-6">
        ...
        <div class="col-sm-12" style="margin-top: 20px;">
          ...
          <select id="inputEmail5" class="form-select" style="color: #8D8D8D;" name="evaluation_period" value="">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            @if(isset($future_target_date[1]) && !empty($future_target_date[1] && $future_target_date[1] !=null))
                              <input type="date" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="future_target_date[]" value="@if(isset($future_target_date[1]) && !empty($future_target_date[1])){{ date('Y-m-d', strtotime($future_target_date[1])) }}@endif">
                            @else 
                            <input type="date" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="future_target_date[]" value="">
                            @endif
                            </td>
                          ...
                          <tr>
                            <td scope="row" colspan="2">
                              @if(isset($future_target[3]) && !empty($future_target[3] && $future_target[3] !=null))
                                <input type="text" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="future_target[]"value="{{ $future_target[3] }} ">
                              @else
                              <input type="text" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="future_target[]" value=" ">
                              @endif
                            </td>
                            ...
                            @if(isset($future_target_date[3]) && !empty($future_target_date[3] && $future_target_date[3] !=null))
                              <input type="date" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="future_target_date[]" value="@if(isset($future_target_date[3]) && !empty($future_target_date[3])){{ date('Y-m-d', strtotime($future_target_date[3])) }}@endif">
                            @else 
                            <input type="date" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="future_target_date[]" value="">
                            @endif
                            </td>
                          ...
                          <tr>
                            <td scope="row" colspan="2">
                              @if(isset($future_target[4]) && !empty($future_target[4] && $future_target[4] !=null))
                                <input type="text" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="future_target[]"value="{{ $future_target[4] }} ">
                              @else
                              <input type="text" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="future_target[]" value=" ">
                              @endif
                            </td>
                            ...
                            @if(isset($future_target_date[4]) && !empty($future_target_date[4] && $future_target_date[4] !=null))
                              <input type="date" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="future_target_date[]" value="@if(isset($future_target_date[4]) && !empty($future_target_date[4])){{ date('Y-m-d', strtotime($future_target_date[4])) }}@endif">
                            @else 
                            <input type="date" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="future_target_date[]" value="">
                            @endif
                            </td>
                          ...
                          <tr>
                            <td scope="row" colspan="2">
                              @if(isset($future_target[5]) && !empty($future_target[5] && $future_target[5] !=null))
                                <input type="text" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="future_target[]"value="{{ $future_target[5] }} ">
                              @else
                              <input type="text" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="future_target[]" value=" ">
                              @endif
                            </td>
                            ...
                            @if(isset($future_target_date[5]) && !empty($future_target_date[5] && $future_target_date[5] !=null))
                              <input type="date" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="future_target_date[]" value="@if(isset($future_target_date[5]) && !empty($future_target_date[5])){{ date('Y-m-d', strtotime($future_target_date[5])) }}@endif">
                            @else 
                            <input type="date" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="future_target_date[]" value="">
                            @endif
                            </td>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            @if(isset($training_titles[3]) && !empty($training_titles[3] && $training_titles[3] !=null))
                              <input type="text" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="training_title[]" value="@if(isset($training_titles[3])){{ $training_titles[3] }} @endif">
                            @else
                              <input type="text" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="training_title[]" value="">
                            @endif
                            </td>
                            ...
                            @if(isset($training_date[3]) && !empty($training_date[3] && $training_date[3] !=null))
                              <input type="date" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="training_date[]" value="@if(isset($training_date[3] )  && !empty($training_date[3])){{$training_date[3] }}@endif">
                            @else
                              <input type="date" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="training_date[]" value="">
                            @endif
                            </td>
                          ...
                          <tr>
                            ...
                            @if(isset($training_titles[4]) && !empty($training_titles[4] && $training_titles[4] !=null))
                              <input type="text" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="training_title[]" value="@if(isset($training_titles[4])){{ $training_titles[4] }} @endif">
                            @else
                              <input type="text" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="training_title[]" value="">
                            @endif
                            </td>
                            ...
                            @if(isset($training_date[4]) && !empty($training_date[4] && $training_date[4] !=null))
                              <input type="date" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="training_date[]" value="@if(isset($training_date[4] )  && !empty($training_date[4])){{$training_date[4] }}@endif">
                            @else
                              <input type="date" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="training_date[]" value="">
                            @endif
                            </td>
                          ...
                          <tr>
                            ...
                            @if(isset($training_titles[5]) && !empty($training_titles[5] && $training_titles[5] !=null))
                              <input type="text" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="training_title[]" value="@if(isset($training_titles[5])){{ $training_titles[5] }} @endif">
                            @else
                              <input type="text" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="training_title[]" value="">
                            @endif
                            </td>
                            ...
                            @if(isset($training_date[5]) && !empty($training_date[5] && $training_date[5] !=null))
                              <input type="date" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="training_date[]" value="@if(isset($training_date[5] )  && !empty($training_date[5])){{$training_date[5] }}@endif">
                            @else
                              <input type="date" class="form-control" id="inputEmail5" style="color: #8D8D8D;" name="training_date[]" value="">
                            @endif
                            </td>
