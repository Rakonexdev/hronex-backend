    ...
    <main id="main" class="main">
        <div class="pagetitle">
            <div class="row align-items-center">
                ...
                <div class="col">
                    <div class="pagetitle">
                        <h1>Employee Leave Sheet</h1>
                        <nav>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('dashboard')}}">Home</a></li>
                            <li class="breadcrumb-item active">Employee Leave Sheet</li>
                        </ol>
                        </nav>
        ...
        <!-- Search Filter -->        
        <form action="{{route('employee_leave_sheet_report')}}" method="post" target="_blank">
        @csrf 
        <div class="row">
                <div class="col-md-2 hidee">
                    <div class="form-group">
                    <label>Start Date</label> <!-- class="focus-label" -->
                        <input type="date" name="date_from" value="{{isset($request->date_from)?$request->date_from:''}}" class="form-control">
                    </div>
                </div>
                <div class="col-md-2 hidee">
                    <div class="form-group">
                    <label>End Date</label> <!-- class="focus-label" -->
                        <input type="date" name="date_to" value="{{isset($request->date_to)?$request->date_to:''}}" class="form-control">
                    </div>
                </div>               
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" list="emplist" id="empList" placeholder="Type to search..." oninput='onInput()' autocomplete="off" required>
                        ...
                        <datalist id="emplist" onclick="" autocomplete="off">
                            @if(0 < count($emp_list))
                                @foreach($emp_list as $eachemps)
                                    <option value="{{$eachemps->name.' '.$eachemps->lname}}" data-id="{{$eachemps->id}}"></option>
                                @endforeach
                            @endif
                        </datalist>
                    </div>
