  ...
  <form action="#">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
          ...
          <input type="date" class="form-control" id="date" style="color: #8D8D8D;" name="date" value="{{$ppr_form->review_date}}" readonly>
        </div>
        <div class="col-sm-6">
          <label for="inputEmail5" class="form-label">Review Period *</label>
          <!-- <input type="text" class="form-control" id="review_period" style="color: #8D8D8D;" name="review_period" value="{{$ppr_form->review_period}}" readonly> -->
          <select id="review_period" name="review_period" class="form-control" style="color: #8D8D8D;" readonly>
                    ...
                    <div class="bg-white">
                      <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th colspan="2">
                                    <input type="text" class="form-control" id="objectives" name="objectives[]" style="color: #8D8D8D;"  value="{{$objectives[0]}}" readonly>
                                </th>
                                <th>
                                    <input type="text" class="form-control" id="discussions" name="discussions[]" style="color: #8D8D8D;"  value="{{$discussion[0]}}" readonly>
                                </th>
                            </tr>
                            <tr>
                                <th colspan="2">
                                    <input type="text" class="form-control" id="objectives" name="objectives[]" style="color: #8D8D8D;"  value="{{$objectives[1]}}" readonly>
                                </th>
                                <th>
                                    <input type="text" class="form-control" id="discussions" name="discussions[]" style="color: #8D8D8D;"  value="{{$discussion[1]}}" readonly>
                                </th>
                            </tr>
                            <tr>
                                <th colspan="2">
                                    <input type="text" class="form-control" id="objectives" name="objectives[]" style="color: #8D8D8D;"  value="{{$objectives[2]}}" readonly>
                                </th>
                                <th>
                                    <input type="text" class="form-control" id="discussions" name="discussions[]" style="color: #8D8D8D;"  value="{{$discussion[2]}}" readonly>
                                </th>
                            </tr>
                        </tbody>
                      </table>
                        ...
                        <tbody>
                            ...
                            @endphp   
                              ...
                              <tr>
                                ...
                                <th>
                                  <select class="form-control" name="ratings[]" readonly>
                      ...
                      <table class="table">
                        ...
                        <tbody>  
                          <tr>
                            ...
                            <th colspan="2">
                              <textarea class="form-control" id="inputAddress2" style="height: 100px; color: #8D8D8D;" name="performance_review_feedback" value="" placeholder="Enter Performance  Feedback" readonly>{{$ppr_form->performance_review_feedback ?? ''}}</textarea>
                            </th>
                          </tr>
                          <tr>
                            <th colspan="2" class="text-wrap">
                            ...
                            <th colspan="2">
                              <textarea class="form-control" id="inputAddress2" style="height: 100px; color: #8D8D8D;" name="require_improvement" value="" placeholder="Enter Performance  Feedback" readonly>{{$ppr_form->require_improvement ?? ''}}</textarea>
                            </th>
                          </tr>
                        </tbody>
                      </table>
                    ...
                    <div class="bg-white">
                      <table class="table">
                        ...
                        <tbody>  
                          ...
                          <tr>
                            <th colspan="2" class="text-wrap">
                              <textarea class="form-control" id="areas_improvement" style="height: 100px; color: #8D8D8D;" name="areas_improvement" value="" placeholder="Enter Areas Improvement" readonly>{{$ppr_form->areas_improvement ?? ''}}</textarea>
                            </th>
                            <th colspan="2">
                              <textarea class="form-control" id="areas_discussion_points" style="height: 100px; color: #8D8D8D;" name="areas_discussion_points" value="" placeholder="Enter any areas require improvement " readonly>{{$ppr_form->areas_discussion_points ?? ''}}</textarea>
                            </th>
                          </tr>
                          <tr>
                            <th colspan="2" class="text-wrap">
                            ...
                            <th colspan="2">
                              <textarea class="form-control" id="work_environment" style="height: 100px; color: #8D8D8D;" name="work_environment" value="" placeholder="Enter Work Environment" readonly>{{$ppr_form->work_environment ?? ''}}</textarea>
                            </th>
                          </tr>
                          <tr>
                            <th colspan="2" class="text-wrap">
                            ...
                            <th colspan="2">
                              <textarea class="form-control" id="manager_action_points" style="height: 100px; color: #8D8D8D;" name="manager_action_points" value="" placeholder="Enter Manager Action Points" readonly>{{$ppr_form->manager_action_points ?? ''}}</textarea>
                            </th>
                          </tr>
                          <tr>
                            <th colspan="2" class="text-wrap">
                            ...
                            <th colspan="2">
                              <textarea class="form-control" id="over_all_perfamance" style="height: 100px; color: #8D8D8D;" name="over_all_perfamance" value="" placeholder="Enter Over All Perfamance" readonly>{{$ppr_form->over_all_perfamance ?? ''}}</textarea>
                            </th>
                          </tr>
                        </tbody>
                      </table>
                      ...
                      <table class="table">
                        ...
                        <tbody>  
                            <tr>
                              <th>
                                <div class="form-check">
                                  ...
                                  <br>
                                  <textarea class="form-control" id="no_conformed" style="height: 100px; color: #8D8D8D;" name="no_conformed" value="" placeholder="if No metion comment" readonly>{{$ppr_form->no_conformed ?? ''}}</textarea>
                                </div>                            
                              </th>
                            </tr>
                            <!-- <tr>
                            ...
                            <tr>
                              ...
                              <th colspan="2">
                                <!-- <textarea class="form-control" id="extension_period" style="height: 100px; color: #8D8D8D;" name="extension_period" value="" placeholder="Extension Period" readonly>{{$ppr_form->extension_period ?? ''}}</textarea> -->
                                <select id="extension_period" name="extension_period" class="form-control" style="color: #8D8D8D;" readonly >
                            ...
                            <tr>
                              <th>
                                <div class="form-check">
                                  <input class="form-check-input" type="checkbox" name="employee_ack" id="employee_ack" @if($ppr_form->employee_ack == 1) checked @endif readonly>
                                  <label class="form-check-label" for="changesMade">
                                    Employee Ackwonleged 
                                  </label>
                                </div>                            
                              </th>
                            </tr>
                            <tr>
                              <th>
                                <div class="form-check">
                                  <input class="form-check-input" type="checkbox" name="hod_ack" id="hod_ack" @if($ppr_form->hod_ack == 1) checked @endif readonly>
                                  <label class="form-check-label" for="changesMade">
                                    Hod Ackwonleged  
                                  </label>
                                </div>                            
                            ...
                            <tr>
                              <th>
                                <div class="form-check">
                                  <input class="form-check-input" type="checkbox" name="principla_ack" id="principla_ack" @if($ppr_form->principla_ack == 1) checked @endif readonly>
                                  <label class="form-check-label" for="changesMade">
                                    Principal Ackwonleged
                                  </label>
                                </div>                            
                              </th>
                            </tr>
